...
public class UserRegistration {
  ...
  /**
   * La contraseña del usuario (debe contener al menos un dígito, una
   * @return password
   */
  @NotNull @Pattern(regexp = "^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).*$") @Size(min = 8) 
  @Schema(name = "password", description = "La contraseña del usuario (debe contener al menos un dígito, una", requiredMode = Schema.RequiredMode.REQUIRED)
